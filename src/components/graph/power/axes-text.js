...
const AxesText = ({Xsteps, Xinterval, Ysteps, Yinterval, Height, indent, HeightInner,
  ...
  for (let i = 0; i < Ysteps; i++) {
      axisYTextArray.push({ Y :4-borderBottom+indent/2 -(Yinterval * i * Ykoef), num : i*Yinterval })
  }
  ...
  return (
    <Fragment>
      <g>
        {axisYText}
        {axisXText}
        {/*<Text x = {XaxisTextOffset-3} y = {-7-borderBottom -(Yinterval * (Ysteps-1) * Ykoef)} > % </Text>*/}
      </g>
    </Fragment>
  )
};
